...
namespace CarBoyWebservice.MBProto.AuthObjectCollection
{
    ...
    public class userPassProductConstructor : AuthMethod
    {
        ...
        public userPassProductConstructor()
        {

        }
        public userPassProductConstructor(long sessionID, long userID, string hash, string smsCode)
        {
        ...
        public override void Read(BinaryReader reader)
        {
            ...
            smsCode = Serializers.String.read(reader);
        }
        ...
        public override byte[] Do()
        {
            ...
            var eng = new Engine();
            var result = eng.userPassProduct(se.userID, hash,smsCode);

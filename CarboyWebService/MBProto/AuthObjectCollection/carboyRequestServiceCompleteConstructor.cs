...
namespace CarBoyWebservice.MBProto.AuthObjectCollection
{
    ...
    public class carboyRequestServiceCompleteConstructor : AuthMethod
    {
        public long sessionID;
        public long userID;
        public string serviceCode;

        public carboyRequestServiceCompleteConstructor()
        {

        }
        public carboyRequestServiceCompleteConstructor(long sessionID, long userID, string serviceCode)
        {
        ...
        public override byte[] Do()
        {
            ...
            var eng = new Engine();
            var result = eng.carboyRequestServiceComplete(se.userID,serviceCode);

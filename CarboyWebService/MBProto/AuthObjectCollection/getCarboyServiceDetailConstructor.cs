...
namespace CarBoyWebservice.MBProto.AuthObjectCollection
{
    ...
    public class getCarboyServiceDetailConstructor : AuthMethod
    {
        ...
        public getCarboyServiceDetailConstructor()
        {

        }
        public getCarboyServiceDetailConstructor(long sessionID, long userID, string serviceCode)
        {
        ...
        public override byte[] Do()
        {
            ...
            var eng = new Engine();
            var result = eng.getCarboyServiceDetail(se.userID, serviceCode);

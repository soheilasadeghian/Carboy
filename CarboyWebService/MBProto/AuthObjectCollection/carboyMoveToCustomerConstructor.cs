...
namespace CarBoyWebservice.MBProto.AuthObjectCollection
{
    ...
    public class carboyMoveToCustomerConstructor : AuthMethod
    {
        public long sessionID;
        public long userID;
        public string serviceCode;

        public carboyMoveToCustomerConstructor()
        {
           
        }
        public carboyMoveToCustomerConstructor(long sessionID, long userID, string serviceCode)
        {
        ...
        public override byte[] Do()
        {
            ...
            var eng = new Engine();
            var result = eng.carboyMoveToCustomer(se.userID,serviceCode);

...
namespace CarBoyWebservice.MBProto.AuthObjectCollection
{
    ...
    public class carboyStartServiceConstructor : AuthMethod
    {
        public long sessionID;
        public long userID;
        public string serviceCode;

        public carboyStartServiceConstructor()
        {

        }
        public carboyStartServiceConstructor(long sessionID, long userID, string serviceCode)
        {
        ...
        public override byte[] Do()
        {
            ...
            var eng = new Engine();
            var result = eng.carboyStartService(se.userID,serviceCode);

...
namespace CarBoyWebservice.MBProto.AuthObjectCollection
{
    ...
    public class getCarboyServiceListConstructor : AuthMethod
    {
        public long sessionID;
        public long userID;
        public long date;

        public getCarboyServiceListConstructor()
        {

        }
        public getCarboyServiceListConstructor(long sessionID, long userID, long date)
        {
        ...
        public override byte[] Do()
        {
            ...
            var eng = new Engine();
            var result = eng.getCarboyServiceList(se.userID,date);

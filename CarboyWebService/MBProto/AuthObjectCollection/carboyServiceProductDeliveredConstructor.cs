...
namespace CarBoyWebservice.MBProto.AuthObjectCollection
{
    ...
    public class carboyServiceProductDeliveredConstructor : AuthMethod
    {
        public long sessionID;
        public long userID;
        public string serviceCode;

        public carboyServiceProductDeliveredConstructor()
        {

        }
        public carboyServiceProductDeliveredConstructor(long sessionID, long userID, string serviceCode)
        {
        ...
        public override byte[] Do()
        {
            ...
            var eng = new Engine();
            var result = eng.carboyServiceProductDelivered(se.userID,serviceCode);

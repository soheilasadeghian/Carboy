...
namespace CarBoyWebservice.MBProto.AuthObjectCollection
{
    ...
    public class geDistributorStartLocationConstructor : AuthMethod
    {
        public long sessionID;
        public long userID;
        public long date;

        public geDistributorStartLocationConstructor()
        {

        }
        public geDistributorStartLocationConstructor(long sessionID, long userID, long date)
        {
        ...
        public override byte[] Do()
        {
            ...
            var eng = new Engine();
            var result = eng.geDistributorStartLocation(se.userID, date);
